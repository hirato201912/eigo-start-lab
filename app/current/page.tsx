...
const QA_ITEMS: QAItem[] = [
  ...
  },
  {
    ...
    a: '英語クラスをご受講いただく場合、維持管理費は1家族につき2,200円となります。塾生は現行2,200円のままで追加はありません。そろばん生は現行1,320円から2,200円に変更となるため、差額880円のご負担となります。ご兄弟が英語クラスを受講される場合も、家族単位で同じ扱いです（塾生のご兄弟は追加なし、そろばん生のご兄弟は差額880円のみ）。なお、先行予約特典の2ヶ月無料期間中は、これらすべてを含めて完全無料です。',
  },
]
